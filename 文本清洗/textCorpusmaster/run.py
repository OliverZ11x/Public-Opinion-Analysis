...
file_ext = '.txt|.csv'
inputpath = './txt/other/single_sentences_list.txt'
inputfile = r'F:\practice code\guasscode\practice_code_guasscode\舆情分析\codes\文本清洗\text-corpus-data-cleaning-master\txt\filtered_sentences_CN.txt'
outpath  = r'F:\practice code\guasscode\practice_code_guasscode\舆情分析\codes\文本清洗\text-corpus-data-cleaning-master\txt\out'
