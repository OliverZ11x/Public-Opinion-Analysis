...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_studio_file", default="./data/yuqing/label_studio.json", type=str, help="The annotation file exported from label studio platform.")
    ...
    parser.add_argument("--options", default=["./data/yuqing/label.txt"], type=str, nargs="+", help="The options for classification.")
